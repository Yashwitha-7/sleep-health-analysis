...
if page == "🏠 Home":
    ...
    **How do lifestyle factors (physical activity, stress, occupation) and physiological indicators 
    ...
    st.header("⚙️ Technical Highlights")
    ...
    with tab2:
        ...
        with col1:
            ...
            if missing_data['Missing Count'].sum() == 0:
                ...
                st.warning(f"⚠️ Found {missing_data['Missing Count'].sum()} missing values")
...
# =============================================================================
    ...
    st.title("⚙️ Data Processing & Feature Engineering")
    ...
    if submit_button:
        ...
        with col1:
            ...
            profile_data = {
                ...
                'Status': [
                    '✅' if 27 <= age <= 59 else '⚠️',
                    '✅' if 7 <= sleep_duration <= 9 else '⚠️',
                    '✅' if physical_activity >= 60 else '⚠️',
                    '✅' if stress_level <= 5 else '⚠️',
                    '✅' if systolic_bp < 120 and diastolic_bp < 80 else '⚠️',
                    '✅' if 60 <= heart_rate <= 80 else '⚠️',
                    '✅' if daily_steps >= 7000 else '⚠️'
                ]
            }
