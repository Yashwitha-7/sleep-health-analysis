...
def load_data():
 ...
 'Heart_Rate': np.random.randint(65, 86, n_samples),
 ...
 # Add 15 heart rate outliers (4.01%)
...
if page == "Home":
 ...
 st.markdown("""The **Sleep Health and Lifestyle Dataset** contains comprehensive information about:
 ...
 **Note on Outliers:** 
 ...
 clinically meaningful observations rather than data entry errors. For example:
 - High heart rates may indicate stress, anxiety, or cardiovascular conditions
 - These values are biologically plausible (95-110 bpm is elevated but not impossible)
 - Removing them would lose important clinical information
 
 Therefore, these outliers have been **retained** for analysis as they may be 
 important predictors of sleep disorders.
 """)
...
# =============================================================================
 ...
 st.markdown("""Categorical variables must be converted to numerical format for machine learning algorithms.
 ...
 **Encoding Complete:** All categorical variables successfully converted to numerical format.
 ...
 st.markdown("""Created **8 new features** based on domain knowledge and exploratory analysis 
 ...
 **Feature Engineering Complete:** Dataset expanded from 13 to 22 features, 
 ...
 st.markdown("""Machine learning algorithms perform better when features are on similar scales.
 ...
 **Scaling Method Selected:** StandardScaler was chosen as the primary scaling method 
 ...
 st.markdown("""Although our primary dataset has no missing values, we demonstrate proficiency with 
 ...
 st.markdown("""We artificially introduced 5% missing values in three features to demonstrate 
 imputation techniques:
 - Sleep Duration
...
# =============================================================================
 ...
 st.markdown("""Developed and validated **10 machine learning models**: 5 for regression (sleep quality prediction) 
 ...
 **Objective:** Predict subjective sleep quality based on lifestyle and physiological factors.
 ...
 plot_bgcolor='white',
 paper_bgcolor='white',
 font=dict(color='#2C3E50', size=12), title_font_color='#2C3E50')
 st.plotly_chart(fig, use_container_width=True)
...
# =============================================================================
 ...
 st.markdown("""Systematic search across 216 parameter combinations to find optimal Random Forest configuration.
 """)
 ...
 **Key Takeaways:**
 ...
 st.markdown("""Understanding which features drive predictions is crucial for model interpretation 
 ...
 paper_bgcolor='white',
 font=dict(color='#2C3E50', size=12), 
 title_font_color='#2C3E50', yaxis={'categoryorder':'total ascending'})
 st.plotly_chart(fig, use_container_width=True)
 ...
 **Clinical Implications:**
 ...
 st.markdown("""Unsupervised learning reveals distinct behavioral phenotypes within the population.
 """)
 ...
 **Cluster 2 - High-Risk Group (~20%):**
 ...
 st.markdown("""Visualizing high-dimensional data in 2D to discover patterns and validate clusters.
 """)
...
# =============================================================================
 ...
 st.markdown("""Use this tool to get **personalized sleep health predictions** based on your lifestyle 
...
# =============================================================================
 ...
 with col1:
 st.markdown("""Stress level emerged as the **single most important predictor** of both sleep quality 
 ...
 **Clinical Implication:** Stress reduction should be prioritized in sleep improvement programs.
 ...
 with col1:
 st.markdown("""All classification models achieved **accuracy exceeding 94%**, with ensemble methods 
 reaching **96.67%**.
